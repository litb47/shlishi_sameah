...
const StorySection: React.FC = () => {
  const stories = [
    {
      ...
      desc: "הסיפור שלנו התחיל עם חנן טל (רחום והקמב\"ץ) - ביום שלישי אחד, חזר מעזה ויצא לבקר חבר לצוות שנפצע שבוע קודם לכן. חנן שאל מה להביא בשביל לשמח אותו ואת השותף שלו לחדר בבית החולים - תל השומר, התשובה הייתה, תביא איזה סטייק טוב. חנן הדליק מנגל בחניה והכין סטייקים לחבר ולשותף לחדר.",
  ...
  return (
    <>
      <section id="story" className="scroll-mt-40 py-20 bg-gradient-to-b from-[#FAF6F6] to-blue-50/30" dir="rtl">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          
          {/* כותרת ראשית */}
          <div className="text-center mb-16 space-y-2">
            <h2 className="text-3xl md:text-5xl font-bold text-[#007aff]">
              איך נולד <span className="text-blue-400">שלישי שמח</span>
            </h2>
