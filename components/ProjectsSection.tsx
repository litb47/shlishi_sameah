...
const ProjectCard: React.FC<ProjectCardProps> = ({ title, description, IconComponent, delay = 0 }) => {
  return (
    // מיכל ראשי ממורכז
    <div className="flex flex-col items-center px-4" style={{ animationDelay: `${delay}ms` }}>
      ...
      {/* כותרת - ממורכזת */}
      <h3
        className="text-xl md:text-2xl font-bold text-[#0D245E] leading-tight mb-4 text-center"
        dangerouslySetInnerHTML={{ __html: title }}
      />

      {/* תיאור - השינוי הגדול כאן:
          1. w-[267px]: רוחב קבוע כמו שביקשת.
          2. mx-auto: ממרכז את הקופסה הצרה הזו בתוך הכרטיס.
          3. text-center: ממרכז את הטקסט בתוך הקופסה.
      */}
      <div 
        className="w-[267px] mx-auto text-center text-[#0D245E] text-[16px] leading-[22px]"
      >
