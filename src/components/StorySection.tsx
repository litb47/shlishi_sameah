...
const StorySection: React.FC = () => {
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          <br /><br />
          <span className=" text-[20px] text-[#0D245E] mt-4 mb-4 font-bold" style={{ fontFamily: "'Guttman Yad', cursive" }}>
  ...
  return (
    <>
      <section id="story" className="scroll-mt-40 py-1 md:py-20 bg-transparent" dir="rtl">
