...
const ProjectCard: React.FC<ProjectCardProps> = ({ title, description, IconComponent, delay = 0 }) => {
  return (
    <div className="flex flex-col items-center text-center px-4" style={{ animationDelay: `${delay}ms` }}>
      ...
      {/* Title - Centered */}
      <h3
        className="text-xl md:text-2xl font-bold text-[#1e3a8a] leading-tight mb-4 min-h-[3.5rem] flex items-center justify-center"
        dangerouslySetInnerHTML={{ __html: title }}
      />

      {/* Description - Centered (התיקון בוצע כאן) */}
      <div
        className="text-base font-normal text-[#334155] leading-relaxed text-center w-full"
  ...
  const projects = [
    {
      ...
      description: `אנחנו לא מסתפקים רק במנגלים. אנחנו עוטפים את החיילים בכל מה שהם צריכים - ביגוד איכותי, ספרי לימוד לאחים הקטנים, ציוד אישי, וכל בקשה שעולה מהלב.<br /><br /><span class="font-bold text-[#1e3a8a]">כי לגיבורים שלנו מגיע הכל. ואנחנו כאן בשבילם.</span>`,
    },
    {
      title: `פרויקט הלגו ע"ש<br />בצלאל מסבכר הי"ד`,
      IconComponent: LegoIcon,
      description: `הוקם באפריל 2025 לזכרו של בצלאל הי"ד. אנחנו רוכשים דגמי לגו יוקרתיים (2,500+ ש"ח) לפי הזמנה אישית של המשתקמים - כי הרכבת לגו היא לא רק תחביב, זו טיפול, ריכוז ושקט נפשי.<br /><br /><span class="font-bold text-[#1e3a8a]">עד כה חילקנו מעל 200 דגמים, ואנחנו ממשיכים!</span>`,
    },
    {
      title: "השבויים ששבו אלינו",
      IconComponent: RibbonIcon,
      description: `פעילות שקטה ומתחת לרדאר במתחם השבים באיכילוב. אנחנו עובדים בשקט - מאבזרים דירות, מספקים קונסולות משחק, מנגלים מקצועיים למשפחות, וכל מה שצריך כדי להעלות חיוך על הפנים של מי שעבר את הבלתי נתפס.<br /><br /><span class="font-bold text-[#1e3a8a]">המטרה שלנו: לתת להם תחושה של בית, של נורמליות, של חיוך.</span>`,
    },
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="bg-[#dbeafe] rounded-[2.5rem] p-8 md:p-16 shadow-sm">
          ...
          <div className="text-center mb-16 space-y-2">
            ...
            <p className="text-lg md:text-2xl text-[#475569] font-medium">
